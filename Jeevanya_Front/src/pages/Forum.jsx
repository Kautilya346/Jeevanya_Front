...
const SupportGroupCard = ({ name, description }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col justify-between min-h-[220px] transition-transform transform hover:-translate-y-2 hover:shadow-xl font-barlow">
      <div>
      ...
      <button
        ...
        className="mt-5 bg-[#4CC0BF] text-white px-5 py-2 rounded-lg font-semibold hover:bg-[#adcecd] hover:text-black transition duration-300 cursor-pointer"
      >
        Join Group
      </button>
    </div>
...
const Forum = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 font-barlow">
      <header className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-gray-900">
          Find Your <span className="text-[#4CC0BF]">Support</span> Community
        </h1>
        <div className="mt-6 flex justify-center relative max-w-lg mx-auto">
          <input
            ...
            className="w-full px-5 py-3 pl-12 border-2 border-gray-300 rounded-full focus:outline-none focus:ring-4 focus:ring-[#4CC0BF] transition duration-300 text-lg"
          />
          <svg
